  ...
  return (
    <div className="flex flex-row gap-2 md:gap-4 w-full md:w-auto items-stretch justify-center mt-8 pointer-events-auto relative z-50">
      ...
      <button
        onClick={toggleVoice}
        disabled={isLoading}
        className={`group relative flex-1 flex flex-col md:flex-row items-center justify-center gap-2 md:gap-3 px-1 py-3 md:px-6 md:py-3 backdrop-blur-md border rounded-lg transition-all duration-300
          ${isLoading
