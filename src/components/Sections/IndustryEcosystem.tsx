...
import { Utensils, ShoppingBag, HeartPulse, Briefcase, Factory, Building, Users } from 'lucide-react';

const industries = [
  { title: "Restaurants & Hospitality", tagline: "Optimizing dynamic, high-volume customer flows.", Icon: Utensils, color: "#F28500" },
  { title: "Retail & E-commerce", tagline: "Mapping the customer journey and automating inventory intelligence.", Icon: ShoppingBag, color: "#007FFF" },
  { title: "Healthcare & Pharma", tagline: "Ensuring data precision, compliance, and rapid knowledge transfer.", Icon: HeartPulse, color: "#7F4FC9" },
  ...
  { title: "Real Estate", tagline: "Structuring asset data for portfolio optimization and high-value transactions.", Icon: Building, color: "#007FFF" },
...
const Card = ({ title, tagline, Icon, color, index }: typeof industries[0] & { index: number }) => {
  return (
    <motion.div
      ...
      className="p-6 rounded-xl bg-black/40 backdrop-blur-md border border-white/10 hover:border-white/30 transition-all duration-300 flex flex-col gap-4 group cursor-default relative overflow-hidden hover:shadow-[0_0_20px_rgba(255,255,255,0.1)]"
    >
      <div className="flex items-center justify-between">
        <Icon className="w-8 h-8 text-white shrink-0 group-hover:animate-pulse" style={{ color: color }} />
